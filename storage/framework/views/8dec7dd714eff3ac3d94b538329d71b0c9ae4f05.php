...
<?php $__env->startSection('content'); ?>
            ...
            <div class="owl-carousel">
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/tires-1.png')); ?>" alt="Image" />
                    </div>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/AutoRepair.png')); ?>" alt="Image" class="img-fluid" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/tyre-services.jpg')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                        <h1>Tire services</h1>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/Alloy-Wheels.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/Auto-Detailing.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/Tinting.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/tow-hitches.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/Windshied-Repairs.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/Body-Repair.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo e(asset('public/web/img/truck.png')); ?>" alt="Image" />
                    </div>
                    <div class="carousel-text">
                        <h3>Calgary services</h3>
    ...
    <div class="about">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="<?php echo e(asset('public/web/img/img-about-company-desc.jpg')); ?>" alt="Image" />
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/service.jpg')); ?>" alt="Image" class="img-fluid" />
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/image-repair.jpg')); ?>" alt="Image" class="img-fluid" />
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/oil-change.jpg')); ?>" alt="Image" class="img-fluid" />
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/performance.jpg')); ?>" alt="Image" class="img-fluid" />
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/scheduled.jpg')); ?>" alt="Image" class="img-fluid" />
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <img src="<?php echo e(asset('public/web/img/transmission.jpg')); ?>" alt="Image" class="img-fluid" />
    ...
    <!-- Facts Start -->
    <div class="facts" data-parallax="scroll" data-image-src="<?php echo e(asset('public/web/img/facts.jpg')); ?>">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="<?php echo e(asset('public/web/img/team-1.jpg')); ?>" alt="Team Image" />
                        </div>
                        <div class="team-text">
                            <h2>Donald John</h2>
                            <p>Engineer</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="<?php echo e(asset('public/web/img/team-2.jpg')); ?>" alt="Team Image" />
                        </div>
                        <div class="team-text">
                            <h2>Adam Phillips</h2>
                            <p>Engineer</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="<?php echo e(asset('public/web/img/team-3.jpg')); ?>" alt="Team Image" />
                        </div>
                        <div class="team-text">
                            <h2>Thomas Olsen</h2>
                            <p>Worker</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="<?php echo e(asset('public/web/img/team-4.jpg')); ?>" alt="Team Image" />
                        </div>
                        <div class="team-text">
                            <h2>James Alien</h2>
                            <p>Worker</p>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-carousel">
                <div class="testimonial-item">
                    <img src="<?php echo e(asset('public/web/img/testimonial-1.jpg')); ?>" alt="Image" />
                ...
                <div class="testimonial-item">
                    <img src="<?php echo e(asset('public/web/img/testimonial-2.jpg')); ?>" alt="Image" />
                    <div class="testimonial-text">
                        <h3>Client Name</h3>
                        <h4>Profession</h4>
                        <p>
                ...
                <div class="testimonial-item">
                    <img src="<?php echo e(asset('public/web/img/testimonial-3.jpg')); ?>" alt="Image" />
                    <div class="testimonial-text">
                        <h3>Client Name</h3>
                        <h4>Profession</h4>
                        <p>
                ...
                <div class="testimonial-item">
                    <img src="<?php echo e(asset('public/web/img/testimonial-4.jpg')); ?>" alt="Image" />
                    <div class="testimonial-text">
                        <h3>Client Name</h3>
                        <h4>Profession</h4>
                        <p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.web.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Calgary\resources\views/index.blade.php ENDPATH**/ ?>
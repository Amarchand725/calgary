                        ...
                        <tbody id="body">
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="id-<?php echo e($permission->id); ?>">
                                    ...
                                    <td><?php echo e(Str::ucfirst($permission->parent)); ?></td>
                                    <td><?php echo e($permission->hasParentPermissions); ?></td>
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-edit')): ?>
                                            <a href="<?php echo e(route('permission.edit', $permission->parent)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-delete')): ?>
                                            <button class="btn btn-danger btn-xs delete" data-slug="<?php echo e($permission->parent); ?>" data-del-url="<?php echo e(url('permission', $permission->parent)); ?>"><i class="fa fa-trash"></i> Delete</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Calgary\resources\views/admin/permission/index.blade.php ENDPATH**/ ?>